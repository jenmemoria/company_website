  ...
  return (
    <footer className='bg-gray-900 text-gray-300'>
        <div className='container mx-auto px-4 py-12'>
            <div className='grid grid-cols-1 md:grid-cols-4 gap-8'> {/*모바일 환경에서 세로로 컴포넌트를 보이기 위해 1로 설정*/}
                <div>
                    <h3 className='text-xl font-bold mb-4'>회사 소개</h3>
                    <p className='text-gray-400'>
                        저희의 회사는 최고의 서비스를 제공하기 위해 노력하고 있습니다.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul className='space-y-2'>
                        ...
                        <li><Link to="/leadershipt" onClick={scrollToTop} className="hover:text-white transition-colors">임원 소개</Link></li>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2025 제은 Company. All rights reserved.</p>
            </div>
        </div>
